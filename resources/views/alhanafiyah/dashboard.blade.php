            ...
            <div class="row g-5">
                @foreach ($beranda as $i => $item)
                    <div class="card shadow m-2" style="width: 19rem;">
                        <img class="card-img-top" style="height: 200px;" src="{{ asset('./admin/img/' . $item->gambar) }}"
                            alt="Card image cap">
                        <div class="card-body">
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title text-success" id="exampleModalLongTitle">Edit Data
                                                Dashboard</h5>
                                            ...
                                            <form action="{{ route('dashboard.update', $item->id) }}" method="POST"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control" id="gambar"
                                                        name="gambar" required autocomplete="gambar"
                                                        value="{{ $item->gambar }}" autofocus
                                                        accept="image/png, image/jpg, image/jpeg">
                                                    <i class="text-danger mb-0">!Format Harus JPG, JPEG or PNG, Ukuran
                                                        Wajib 1366 * 768</i>
                                                </div>
                                                <div class="form-group">
                                                    <label for="judul" class="form-label">Title</label>
                                                    <input type="text" class="form-control" id="judul"
                                                        name="judul" required autocomplete="judul" autofocus
                                                        value="{{ $item->judul }}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="isi" class="form-label">Content</label>
                                                    <textarea name="isi" id="isi" class="form-control" required autocomplete="isi" autofocus cols="30"
                                                        rows="10" style="height:100px;">{{ $item->isi }}</textarea>
                                                </div>
                                        </div>
                            ...
                            <div class="modal fade" id="deleteModal{{ $item->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title text-success" id="exampleModalLabel">Delete Data
                                                Dashboard</h5>
                                            <button type="button" class="close" data-dismiss="modal"
                                                aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-sm shadow-sm btn-secondary"
                                                data-dismiss="modal">Close</button>
                    ...
                    <form action="{{ route('dashboard.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" id="gambar" name="gambar" required
                                autocomplete="gambar" autofocus accept="image/png, image/jpg, image/jpeg">
