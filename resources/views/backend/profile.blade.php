        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-datatable table-responsive pt-0">
                    <table class="datatables-basic-profile table">
                        <thead>
                            <tr>
                                <th></th>
                                <th>id</th>
            ...
            <div class="offcanvas offcanvas-end" id="add-new-profile">
                ...
                <div class="offcanvas-body flex-grow-1">
                    <form class="add-new-profile pt-0 row g-2" id="formValidationExample" onsubmit="return false">
                        @csrf
                        <input type="hidden" id="form-id" name="id">
                        <div class="col-sm-12">
                            <label class="form-label" for="logo">Icon</label>
                            <div class="input-group input-group-merge">
                                <span id="logo2" class="input-group-text"><i class="ti ti-file-plus"></i></span>
                                <input type="file" id="logo" class="form-control dt-logo" name="logo"
                                    aria-describedby="logo2" accept="image/png, image/jpg, image/jpeg" />
                            </div>
                        </div>
                        <div class="col-sm-12">
