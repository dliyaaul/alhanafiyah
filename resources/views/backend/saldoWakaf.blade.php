    ...
    <div class="row">
        ...
        <div class="card">
            <div class="card-datatable table-responsive pt-0">
                <table class="datatables-basic-saldoWakaf table">
                    <thead>
                        <tr>
                            <th></th>
                            <th>id</th>
        ...
        <div class="offcanvas offcanvas-end" id="add-new-saldowakaf">
            <div class="offcanvas-header border-bottom">
                <h5 class="offcanvas-title label" id="exampleModalLabel"></h5>
                <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
            </div>
            <div class="offcanvas-body flex-grow-1">
                <form class="add-new-saldowakaf pt-0 row g-2" id="formValidationExample" onsubmit="return false">
                    @csrf
                    <input type="hidden" id="form-id" name="id">
                    <div class="col-sm-12">
                        <label class="form-label" for="nama">Name</label>
                        <div class="input-group input-group-merge">
                            <span id="nama2" class="input-group-text"><i class="ti ti-tags"></i></span>
                            <input type="text" id="nama" name="nama" class="form-control dt-nama"
                                placeholder="Masukkan Name" aria-label="Masukkan Name" aria-describedby="nama2" />
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <label class="form-label" for="penerima">Receiver</label>
                        <div class="input-group input-group-merge">
                            <span id="penerima2" class="input-group-text"><i class="ti ti-tags"></i></span>
                            <input type="text" id="penerima" name="penerima" class="form-control dt-penerima"
                                placeholder="Masukkan Receiver" aria-label="Masukkan Receiver"
                                aria-describedby="penerima2" />
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <label class="form-label" for="jumlah">Amount</label>
                        <div class="input-group input-group-merge">
                            <span id="jumlah2" class="input-group-text"><i class="ti ti-tags"></i></span>
                            <input type="number" id="jumlah" name="jumlah" class="form-control dt-jumlah"
                                placeholder="Masukkan Amount" aria-label="Masukkan Amount" aria-describedby="jumlah2" />
                        </div>
                    </div>
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                        <label class="form-label" for="keterangan">Content</label>
                        <div class="input-group input-group-merge">
                            <textarea name="keterangan" id="keterangan" class="form-control dt-keterangan" cols="30" rows="10"></textarea>
                        </div>
                    </div>
                    <div class="col-sm-12">
...
@section('pageJs')
    ...
    <script src="../../assets/js/tables-saldo-wakaf-datatables-basic.js"></script>
