...
<head>
    ...
    <title>Backend Musholla | Al-Hanafiyah An-Nahdliyah</title>
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        <img src="{{ asset('template/img/logo-musholla.png') }}" alt
                        ...
                        <div class="container-xxl">
                            <div
                                ...
                                <div>
                                    ...
                                    , made with ❤️ by
                                    <a href="https://www.instagram.com/muhammad_dliyaaul/" target="_blank"
                                        class="footer-link text-primary fw-medium">Muhammad Dliyaa'ul</a>
                                </div>
